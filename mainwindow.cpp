...
void MainWindow::on_actionHow_to_use_triggered()
{
  ...
  helpWindow->setWindowTitle ("About Ground Motion System");
  helpWindow->show();
}
...
void MainWindow::on_actionConnect_triggered()
{
  if (connected)
  ...
  else
    {
      ...
      int baudRate = ui->comboBaud->currentText().toInt();                              // Get baud rate from combo box                             // Get index of parity combo box
